...
3. Fazer melhorias;
4. Processar turno.
Não há limite no número de ações que se podem fazer (1 a 3). A opção 4 é a única para se processar o turno.
...
1. Ficas sem água (consumo excessivo ou furo no depósito).
2. Perdes as culturas (causada pela tempestade).
